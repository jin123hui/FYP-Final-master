        ...
        client.setCallback(new MqttCallback() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                for(EncodedApplicationEvent e : arrList1){
                    ...
                    int firstBracket = e.getSoftSkillPoint().indexOf("{");
                    String softSkill = e.getSoftSkillPoint().substring(firstBracket + 1, e.getSoftSkillPoint().indexOf("}"));

                    evt.setEventTitle(e.getEventTitle());
                    evt.setSoftSkillPoint(softSkill);
                    arrList.add(evt);


                    StringTokenizer tokens = new StringTokenizer(softSkill, ",");
                    //Toast.makeText(SoftSkill.this, softSkill, Toast.LENGTH_LONG).show();
