...
public class EventRegistration implements Serializable{
    ...
    public EventRegistration(int registrationId, String timetableId, GregorianCalendar registerDate, String studentId, String status, String leaderId, String description, String notificationStatus, String waitingListStatus) {
