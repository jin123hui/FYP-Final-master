        ...
        client.setCallback(new MqttCallback() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                if (obj.getString("success").equals("1")){
                    ...
                    reg.setTimetableId(registration.getTimetableId());
                                    ...
                                    client.setCallback(new MqttCallback() {
                                        ...
                                        public void messageArrived(String topic, MqttMessage message) throws Exception {
                                           ...
                                           // btnUpdateTeam.setVisibility(View.GONE);
                                            ...
                                            if(arrList1.get(0).getLeaderId().equals(studentId)) {
                                                builder.setNeutralButton("Edit group info", new DialogInterface.OnClickListener() {
                                                    @Override
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                if(!obj.getString("clientMsg").isEmpty() && obj.getString("clientMsg").equals("Marked") && obj.getString("registrationId").equals(reg.getRegistrationId()+"")) {
                    ...
                    if(attnd.getStatus().equals("Active")) {
                        if(attnd.getEventSession().equals(""))
