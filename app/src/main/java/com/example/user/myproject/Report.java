...
public class Report extends AppCompatActivity {
    ...
    public void saveImage(Bitmap bitmap) throws IOException {
        ...
        File f = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/ss.png");
        f.mkdirs();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            /*case R.id.action_save_report:
                //savePdf();
                final LinearLayout linearLayout = (LinearLayout) findViewById(R.id.svreport);
                linearLayout.post(new Runnable() {
                    public void run() {

                        //take screenshot
                        Bitmap myBitmap = captureScreen(linearLayout);
