...
public class DetailedListAdapter extends ArrayAdapter<ApplicationEvent> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.venue.setText(": " + evt.getVenueName());

        String remainingTime = calcRemainingTime(evt.getStartTime());
        if(remainingTime.startsWith("-"))
            viewHolder.remainingTime.setText("NOW");
        else
            viewHolder.remainingTime.setText(remainingTime);
